...
return [
    ...
    'help' => [
        'pseudo' => 'Doit correspondre au compte Azuriom du créateur (pour créditer la monnaie du site).',
        'code' => 'Code que le joueur tapera dans la boutique.',
        'percentage' => 'Le créateur reçoit ce % des :money achetés, en plus. Rien n’est retiré au joueur.',
    ],
    'errors' => [
